...
namespace Microsoft.AspNet.Routing.Template.Tests
{
    public class TemplateRouteParserTests
    {
        ...
        public void Parse_SingleLiteral()
        {
            ...
            var expected = new RoutingTemplate(new List<TemplateSegment>());
            ...
            // Assert
            Assert.Equal<RoutingTemplate>(expected, actual, new TemplateEqualityComparer());
        }
        ...
        private class TemplateEqualityComparer : IEqualityComparer<RoutingTemplate>
        {
            public bool Equals(RoutingTemplate x, RoutingTemplate y)
            {
                if (x == null && y == null)
                {
                    return true;
            ...
            public int GetHashCode(RoutingTemplate obj)
            {
