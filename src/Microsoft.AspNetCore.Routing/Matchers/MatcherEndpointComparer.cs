...
namespace Microsoft.AspNetCore.Routing.Matchers
{
    ...
    internal class MatcherEndpointComparer : IComparer<MatcherEndpoint>, IEqualityComparer<MatcherEndpoint>
    {
        ...
        public MatcherEndpointComparer(EndpointSelectorPolicy[] policies)
        {
            ...
            {
                _comparers[i + 2] = new EndpointMetadataComparer(policies[i]);
            }
        }
        ...
        public int Compare(MatcherEndpoint x, MatcherEndpoint y)
        {
            ...
            return compare == 0 ? x.Template.CompareTo(y.Template) : compare;
        }
        ...
        private class PrecedenceComparer : IComparer<MatcherEndpoint>
        {
            ...
            public int Compare(MatcherEndpoint x, MatcherEndpoint y)
            {
                return RoutePrecedence.ComputeInbound(x.ParsedTemplate)
                    .CompareTo(RoutePrecedence.ComputeInbound(y.ParsedTemplate));
            }
        }
    }
}
