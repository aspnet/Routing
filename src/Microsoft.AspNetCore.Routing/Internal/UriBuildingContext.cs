...
namespace Microsoft.AspNetCore.Routing.Internal
{
    ...
    public class UriBuildingContext
    {
        ...
        public UriBuildingContext(UrlEncoder urlEncoder)
        {
            ...
            QueryStringWriter = new StringWriter(_query);
            _lastValueOffset = -1;
        ...
        public TextWriter QueryStringWriter { get; }
        ...
        public PathString ToPathString()
        {
            ...
            return PathString.FromUriComponent(_path.ToString());
        }
        ...
        public QueryString ToQueryString()
        {
            ...
            return QueryString.FromUriComponent(_query.ToString());
        }
