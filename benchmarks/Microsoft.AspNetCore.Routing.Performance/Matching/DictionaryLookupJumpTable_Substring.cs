...
{
    internal class DictionaryLookupJumpTable_Substring : JumpTable
    {
        private readonly int _defaultDestination;
        private readonly int _exitDestination;
        private readonly Dictionary<int, (string text, int destination)[]> _store;

        public DictionaryLookupJumpTable_Substring(
        ...
        {
            return StringComparer.OrdinalIgnoreCase.GetHashCode(path.Substring(segment.Start, segment.Length));
        }
    }
}
